...
export default function UserOrders() {
    ...
    return (
        <div className="w-full min-h-screen bg-primary p-4 sm:p-6 text-text mt-20">
            ...
            {/* Header */}
            <div className="mb-6 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mt-5">
