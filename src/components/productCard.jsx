  ...
  return (
    <div
      className="w-[300px] h-[450px] bg-white rounded-2xl shadow-md 
                 ...
                 overflow-hidden m-3 flex flex-col group hover:-translate-y-1 mt-8 z-40"
    >
      {/* Image */}
      ...
      <div className="flex flex-col gap-2 p-4 flex-1">
        ...
        {/* CTA */}
        <Link
          to={`/overview/${product.productID}`} // Use productID here
          className="w-full text-center py-2.5 rounded-xl border border-accent text-accent font-semibold tracking-wide text-sm hover:bg-accent hover:text-white transition-all duration-300"
        >
          View Product
        </Link>
      </div>
